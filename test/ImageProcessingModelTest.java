...
//
//  public ImageProcessingModelTest() {
//  }
//
//  @Before
//  public void init() {
...
//        {new PixelImpl(0, 0, 0), new PixelImpl(255, 255, 255), new PixelImpl(255, 255, 255)},
//        {new PixelImpl(5, 5, 5), new PixelImpl(250, 250, 250), new PixelImpl(250, 250, 250)},
//        {new PixelImpl(100, 100, 100), new PixelImpl(100, 100, 100), new PixelImpl(100, 100, 100)},
//        {new PixelImpl(250, 250, 250), new PixelImpl(5, 5, 5), new PixelImpl(5, 5, 5)},
//        {new PixelImpl(255, 255, 255), new PixelImpl(0, 0, 0), new PixelImpl(0, 0, 0)}};
//    this.testModel.getLoadMap().put("dumby", new PixelImage(dumbyPicture));
//    this.testModel.getLoadMap().put("nullImage", (Object) null);
//  }
//
//  @Test
//  
...
//
//    sb2.append(
//        "0 0 0 255 255 255 255 255 255 5 5 5 250 250 250 250 250 250 100 100 100 100 100 100 100 100 100 250 250 250 5 5 5 5 5 5 255 255 255 0 0 0 0 0 0 ");
...
//
//    sb2.append(
//        "10 10 10 255 255 255 255 255 255 15 15 15 255 255 255 255 255 255 110 110 110 110 110 110 110 110 110 255 255 255 15 15 15 15 15 15 255 255 255 10 10 10 10 10 10 ");
//    Assert.assertEquals(sb1.toString(), sb2.toString());
//  }
//
//  
...
//
//    sb2.append(
//        "0 0 0 245 245 245 245 245 245 0 0 0 240 240 240 240 240 240 90 90 90 90 90 90 90 90 90 240 240 240 0 0 0 0 0 0 245 245 245 0 0 0 0 0 0 ");
//    Assert.assertEquals(sb1.toString(), sb2.toString());
//  }
//
//  
...
//  
//
//  public void axisIsNull() {
//    this.testModel.flipImage((String) null, "dumby", "dumby2");
//  }
//
//  
//  @Test
...
//
//    sb2.append(
//        "255 255 255 255 255 255 0 0 0 250 250 250 250 250 250 5 5 5 100 100 100 100 100 100 100 100 100 5 5 5 5 5 5 250 250 250 0 0 0 0 0 0 255 255 255 ");
//    Assert.assertEquals(sb1.toString(), sb2.toString());
//  }
//
//  
...
//    Pixel[][] dumbyHorizontal = ((Image) this.testModel.getLoadMap().get("dumbyHorizontal")).getImage();
//    StringBuilder sb1 = new StringBuilder();
//    StringBuilder sb2 = new StringBuilder();
//
...
//
//    sb2.append(
//        "255 255 255 0 0 0 0 0 0 250 250 250 5 5 5 5 5 5 100 100 100 100 100 100 100 100 100 5 5 5 250 250 250 250 250 250 0 0 0 255 255 255 255 255 255 ");
...
//    int row;
//    for (int row = 0; row < dumbyVert.length; ++row) {
//      for (row = 0; row < dumbyVert[0].length; ++row) {
...
//    Pixel[][] dumbyVertVert = ((Image) this.testModel.getLoadMap().get("dumbyVertVert")).getImage();
//
//    for (row = 0; row < dumbyVert.length; ++row) {
//      for (int col = 0; col < dumbyVert[0].length; ++col) {
...
//    int row;
//    for (int row = 0; row < dumbyHorizontal.length; ++row) {
//      for (row = 0; row < dumbyHorizontal[0].length; ++row) {
...
//    Pixel[][] dumbyHorizontalVert = ((Image) this.testModel.getLoadMap().get("dumbyHorizontalVert")).getImage();
//
//    for (row = 0; row < dumbyHorizontalVert.length; ++row) {
...
//    Pixel[][] dumbyHorizontalVert = ((Image) this.testModel.getLoadMap().get("dumbyHorizontalVert")).getImage();
//
//    for (row = 0; row < dumbyHorizontal.length; ++row) {
//      for (int col = 0; col < dumbyHorizontal[0].length; ++col) {
//        var10001 = dumbyHorizontalVert[row][col].getRed();
//        sb3.append(var10001 + " ");
//        var10001 = dumbyHorizontalVert[row][col].getGreen();
...
//
//    sb4.append(
//        "0 0 0 0 0 0 255 255 255 5 5 5 5 5 5 250 250 250 100 100 100 100 100 100 100 100 100 250 250 250 250 250 250 5 5 5 255 255 255 255 255 255 0 0 0 ");
//    Assert.assertEquals(sb3.toString(), sb4.toString());
//  }
//
//  
...
//        "255 255 255 255 255 255 0 0 0 250 250 250 250 250 250 5 5 5 100 100 100 100 100 100 100 100 100 5 5 5 5 5 5 250 250 250 0 0 0 0 0 0 255 255 255 ");
//    Assert.assertEquals(sb1.toString(), sb2.toString());
//    this.testModel.flipImage("horizontal", "dumbyVert", "dumbyVertHorizontal");
//    Pixel[][] dumbyVertHorizontal = ((Image) this.testModel.getLoadMap().get("dumbyVertHorizontal")).getImage();
//
//    for (row = 0; row < dumbyVertHorizontal.length; ++row) {
